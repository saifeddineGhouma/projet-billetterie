...
<head>
    ...
    <title>Foot Free Admin Template  | Admin Dashboad Template</title>
    ...
    <a href="{{ route('logout') }}"
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('equipe_liste')}}">
                            <i class="fa fa-bar-chart-o fa-fw">
                            </i> Gere Les EQUIPE<span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="flot.html">LES equipes </a>
                            </li>
                            <li>
                                <a href="morris.html">Ajouter Equipes</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i>Gere les Zones<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i>Gere les stades<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>Gere les match<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
        ...
        <div id="page-wrapper"style="background-color:#fff" >
            ...
            <div class="row" >
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">@if(session()->has('success'))
